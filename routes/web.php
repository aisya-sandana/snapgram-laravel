...
Route::middleware('auth')->group(function () {
    ...
    // Photo like and comments routes
    Route::post('photos/{photo}/like', [PhotoController::class, 'like'])->name('photos.like');
    Route::prefix('photos/{photo}/comments')->group(function () {
        Route::get('/', [PhotoController::class, 'showComments'])->name('photos.comments');
        Route::post('/', [PhotoController::class, 'storeComment'])->name('photos.comments.store');
    });
